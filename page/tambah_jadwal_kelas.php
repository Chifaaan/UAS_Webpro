    ...
    <div class="basis-4/4">
      <div class="px-4">
        <div class="rounded-md mb-2  h-max relative bg-yellow-400 p-4 text-left text-lg font-bold ">
          <a href="detil_admin.html" class="text-black-200 bg-sky-100 active:bg-sky-100 pb-5 pt-4 px-9 mr-1 hover:underline  h-full ">✍️ Form Isi </a>
          ...
          <a href="Ruangan_admin.html" class="text-black-200 bg-yellow-400 hover:bg-sky-100 pb-4 pt-4 px-9 mr-1 hover:underline hover:pb-5 transition-all h-full ">🏫 Fasilitas Ruangan </a>
        </div>
        <div class="rounded-md mb-2 shadow-slate-400 shadow-lg  h-max relative bg-white p-4">
          <form action="../util/proses_tambah_jadwal.php" method="post">
            ...
            <a href="tambah_jadwal_kelas.html" class="mt-4 p-2 rounded bg-red-400 text-white ">❌ Batal</a>
          </form>
        </div>
      </div>
    </div>
